    ...
    <style>
        * {
        ...
        .error-card {
            background: #ffffff;
            border-radius: 28px;
            box-shadow: 0 25px 50px -12px rgba(0, 45, 114, 0.12);
        ...
        .error-card::before {
            ...
            right: 0;
            height: 6px;
            background: linear-gradient(90deg, #002d72, #0284c7, #10b981);
        }
        .error-badge {
            display: inline-flex;
            align-items: center;
        ...
        .error-code {
            ...
            font-weight: 900;
            line-height: 1;
            background: linear-gradient(135deg, #002d72, #0284c7);
...
<body>
    <div class="error-card">
        <div class="error-badge">
            ...
            خطای یافت نشدن نشانی
        </div>
        <div class="error-code">۴۰۴</div>
        <h1>صفحه مورد نظر شما پیدا نشد!</h1>
        <p>
            صفحه‌ای که به دنبال آن بودید ممکن است حذف شده باشد، نام آن تغییر کرده باشد، یا نشانی اینترنتی آن را اشتباه وارد کرده باشید. می‌توانید از پیوندهای زیر برای دسترسی سریع به بخش‌های اصلی آسنا استفاده کنید.
        </p>
        ...
        <div class="emergency-box">
            <div>نیاز به پشتیبانی یا مشاوره فوری دارید؟</div>

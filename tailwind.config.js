...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "headline-lg-mobile": ["Geist", "Vazirmatn", "sans-serif"],
        "headline-lg": ["Geist", "Vazirmatn", "sans-serif"],
        "label-sm": ["Geist", "Vazirmatn", "sans-serif"],
        "headline-md": ["Geist", "Vazirmatn", "sans-serif"],
        "display-lg": ["Geist", "Vazirmatn", "sans-serif"],
        "title-lg": ["Geist", "Vazirmatn", "sans-serif"],
        "label-lg": ["Geist", "Vazirmatn", "sans-serif"],
        "body-lg": ["Geist", "Vazirmatn", "sans-serif"],
        "body-md": ["Geist", "Vazirmatn", "sans-serif"]
      },
      fontSize: {
